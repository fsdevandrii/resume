...
var header = {
  ...
  salary: '600$ в місяць',
  address: 'London EC2A 4HJ, United Kingdom',
}
...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      educations: [
        {
          name: 'École 42 (France)',
          isEnd: true,
        },
        {
          name: 'CODE University of Applied Sciences (Germany)',
          isEnd: true,
        },
        {
          name: 'Codeworks (Spain)',
          isEnd: true,
        },
        {
          name: 'Makers Academy (United Kingdom)',
          isEnd: false,
        },
        {
          name: 'Hacktiv8 (Netherlands)',
          isEnd: false,
        },
      ],
...
router.get('/work', function (req, res) {
  ...
  res.render('work', {
    ...
    main: {
      works: [
        {
          position: 'Jonior Fullstack Developer',
          company: {
            name: 'IT Brains',
          ...
          projects: [
            {
              ...
              about:
                'Now, with the “internet of things,” nearly everything needs some sort of attention to the user experience.',
              stacks: [
                {
                  name: 'React.js',
                },
              ...
              awards: [
                {
                  name: 'Background verification - is a future that provides users to prove that thay are real persons.',
                },
                {
                  name: 'Preparing SEO optimbzed pages. The automated process of getting data for the app from documents.',
                },
              ],
              stackAmount: {
                point: 3,
